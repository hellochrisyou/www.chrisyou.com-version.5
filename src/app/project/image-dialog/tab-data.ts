...
export const FOOTBALLIMAGES: string[] = [
    '../../assets/img/project/ff2.png',
    '../../assets/img/project/ff3.png',
    '../../assets/img/project/ff4.png',
    '../../assets/img/project/ff5.png',
    '../../assets/img/project/ff-diagram.png'
];
