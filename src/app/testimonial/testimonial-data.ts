...
export const TESTIMONYJOBS: string[] = [
    'Validations Test Engineer', 'Software Engineer', 'Software Developer'
]

export const TESTIMONYCOMPANY: string[] = [
    'LG', 'Microsoft', 'AINS'
]
...
export const TESTIMONYTEXT: string[] = [
    ...
    // tslint:disable-next-line: max-line-length
    'Watching Chris grow as a programmer while we worked together at AINS has been very inspiring. His curiosity is one notable chacteristic that will go a long way in the IT industry. I feel very privileged to have been his mentor.',
    // tslint:disable-next-line: max-line-length
